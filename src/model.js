import {tick, acceleration, reverse, friction, steeringRadius, height, width, maxHealth} from './constants.js';
...
class Vehicle extends MovingEntity {
    ...
    move() {
        ...
        const linearDistance = 2 * steeringRadius * Math.sin(steeringAngle / 2);
