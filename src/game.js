import {width, height, rocketTTL, rocketIncrement, collisionRadius} from "./constants.js";
        ...
        switch (event.object) {
            ...
            case ' ':
                if (event.action === 'keydown') {
                    const rocket = new Rocket(this.id(), this.timestamp(), vehicle.x, vehicle.y, vehicle.speed + rocketIncrement, vehicle.angle);
